 ...
 function GetImageExtension($imagetype)
	...
	if (!empty($_FILES["file"]["name"])) {
		...
		if(move_uploaded_file($temp_name, $target_path)) {
			...
			mysql_query("UPDATE members SET id_members = '$id_members',  nama='$nama', telp='$telp', nim='$nim', universitas ='$kuliah', path_idcard='$target_path', email='$email' WHERE id_members= '$id_members'");
			...
			mysql_query("UPDATE members SET id_members = '$id_members',  nama='$nama', telp='$telp', nim='$nim', universitas ='$kuliah', email='$email' WHERE id_members= '$id_members'");
