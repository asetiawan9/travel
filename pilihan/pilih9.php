...
<?php
 ...
 <!--=================================================START 11C=========================================================-->
<?php
			    $c1=mysql_fetch_array(mysql_query("SELECT * FROM kursi WHERE kursi.id_tiket='$_GET[id]' AND nama_kursi='11C'"));	
			  if($c1['nama_kursi']=="11C"){
			  echo"<label class='btn btn-warning'>
				    <input name='kursi[]' value='11C' id='11C' onclick='cer(this)' autocomplete='off' disabled='disabled' type='checkbox'>11C
					</label>";}
			  else {
			  echo"<label class='btn btn-default'>
				    <input name='kursi[]' value='11C' id='11C' onclick='cer(this)' autocomplete='off' type='checkbox'>11C
					</label>";}
			   ?>
			   
			   <!--=================================================START 11D=========================================================-->
<?php
			    $c1=mysql_fetch_array(mysql_query("SELECT * FROM kursi WHERE kursi.id_tiket='$_GET[id]' AND nama_kursi='11D'"));	
			  if($c1['nama_kursi']=="11D"){
			  echo"<label class='btn btn-warning'>
				    <input name='kursi[]' value='1D' id='11D' onclick='cer(this)' autocomplete='off' disabled='disabled' type='checkbox'>11D
					</label>";}
			  else {
			  echo"<label class='btn btn-default'>
				    <input name='kursi[]' value='11D' id='11D' onclick='cer(this)' autocomplete='off' type='checkbox'>11D
					</label>";}
			   ?>	
				</td>
