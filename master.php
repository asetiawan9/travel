...
<?php include "konten.php"; ?>
		 ...
		 <p class="text-right"><kbd>Copyright © 2016 <?php $sql2 = mysql_query("select nama_website from identitas LIMIT 1");
      											   $j2   = mysql_fetch_array($sql2);
												   echo "$j2[nama_website]";?>. All Rights Reserved</kbd></p></div>
	    </div>
    </div>
   </body>
   </html>